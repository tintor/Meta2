...
public class RMath {
	 ...
	 */
	public static double nextfp(final double x) {
		double y;

		if (x == 0)
			return Double.longBitsToDouble(1);
		else if (x < Double.POSITIVE_INFINITY) {
			final long xx = Double.doubleToLongBits(x);
			if (x > 0) {
	...
	public static double prevfp(final double x) {
		if (x == 0)
			return -nextfp(0.0);
		else
			return -nextfp(-x);
	...
	public static double add_lo(final double x, final double y) {
		return prevfp(x + y);
	}

	public static double add_hi(final double x, final double y) {
		return nextfp(x + y);
	}

	public static double sub_lo(final double x, final double y) {
		return prevfp(x - y);
	}

	public static double sub_hi(final double x, final double y) {
		return nextfp(x - y);
	}

	public static double mul_lo(final double x, final double y) {
		if (x == 0.0 || y == 0.0)
			return 0.0;
		return prevfp(x * y);
	}

	public static double mul_hi(final double x, final double y) {
		if (x == 0.0 || y == 0.0)
			return 0.0;
		return nextfp(x * y);
	}

	public static double div_lo(final double x, final double y) {
		if (x == 0.0)
			return 0.0;
		return prevfp(x / y);
	}

	public static double div_hi(final double x, final double y) {
		if (x == 0.0)
			return 0.0;
		return nextfp(x / y);
	}

	public static double exp_lo(final double x) {
	...
	public static double exp_hi(final double x) {
		if (x == Double.NEGATIVE_INFINITY)
			return 0.0;
		else if (x < Double.POSITIVE_INFINITY)
	...
	public static double log_lo(final double x) {
		if (x < 0.0)
			return Double.NaN;
		else if (x < Double.POSITIVE_INFINITY)
	...
	public static double log_hi(final double x) {
		if (x < 0.0)
			return Double.NaN;
		else if (x < Double.POSITIVE_INFINITY)
	...
	public static double sin_lo(final double x) {
		return prevfp(Math.sin(x));
	}

	public static double sin_hi(final double x) {
		return nextfp(Math.sin(x));
	}

	public static double cos_lo(final double x) {
		return prevfp(Math.cos(x));
	}

	public static double cos_hi(final double x) {
		return nextfp(Math.cos(x));
	}

	public static double tan_lo(final double x) {
		return prevfp(Math.tan(x));
	}

	public static double tan_hi(final double x) {
		return nextfp(Math.tan(x));
	}

	public static double asin_lo(final double x) {
		return prevfp(Math.asin(x));
	}

	public static double asin_hi(final double x) {
		return nextfp(Math.asin(x));
	}

	public static double acos_lo(final double x) {
		return prevfp(Math.acos(x));
	}

	public static double acos_hi(final double x) {
		return nextfp(Math.acos(x));
	}

	public static double atan_lo(final double x) {
		return prevfp(Math.atan(x));
	}

	public static double atan_hi(final double x) {
	...
	/*
	  ...
	  ia_math package.
	 */
	static double sin2pi_lo(final double x) {
		return prevfp(Math.sin(prevfp(Math.PI * 2 * x)));
	}

	static double sin2pi_hi(final double x) {
		return nextfp(Math.sin(nextfp(Math.PI * 2 * x)));
	}

	static double cos2pi_lo(final double x) {
		if (x > 0)
	...
	static double cos2pi_hi(final double x) {
		if (x > 0)
	...
	static double tan2pi_lo(final double x) {
		return prevfp(Math.tan(prevfp(Math.PI * 2 * x)));
	}

	static double tan2pi_hi(final double x) {
	...
	static double asin2pi_lo(final double x) {
		return prevfp(Math.asin(x) / nextfp(Math.PI * 2));
	}

	static double asin2pi_hi(final double x) {
		return nextfp(Math.asin(x) / prevfp(Math.PI * 2));
	}

	static double acos2pi_lo(final double x) {
		return prevfp(Math.acos(x) / nextfp(Math.PI * 2));
	}

	static double acos2pi_hi(final double x) {
		return nextfp(Math.acos(x) / prevfp(Math.PI * 2));
	}

	static double atan2pi_lo(final double x) {
		return prevfp(Math.atan(x) / nextfp(Math.PI * 2));
	}

	static double atan2pi_hi(final double x) {
	 ...
	 */
	public static double pow_lo(final double x, final double y) {
		if (x < 0)
			return Double.NaN;
		else if (x == 0.0)
			return 0.0;
	 ...
	 */
	public static double pow_hi(final double x, final double y) {
		if (x < 0)
			return Double.NaN;
		else if (x == 0.0)
			return 0.0;
