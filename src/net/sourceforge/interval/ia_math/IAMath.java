...
public class IAMath {
	...
	public static final boolean nonempty(final RealInterval x) {
		return x.lo <= x.hi;
	}

	public static RealInterval intersect(final RealInterval x, final RealInterval y) throws IAException {
		return new RealInterval(Math.max(x.lo, y.lo), Math.min(x.hi, y.hi));
	}

	public static RealInterval union(final RealInterval x, final RealInterval y) throws IAException {
	...
	public static RealInterval add(final RealInterval x, final RealInterval y) {
		final RealInterval z = new RealInterval();
	 ...
	 */
	public static RealInterval div(final RealInterval x, final RealInterval y) {
	 ...
	 * y is nonempty.
	 */
	public static boolean intersect_odiv(final RealInterval y, final RealInterval z, final RealInterval x)
			throws IAException {
		if (x.lo >= 0 || x.hi <= 0) {
			y.intersect(IAMath.odiv(z, x));
			return true;
		} else if (z.lo > 0) {
			final double tmp_neg = RMath.div_hi(z.lo, x.lo);
			final double tmp_pos = RMath.div_lo(z.lo, x.hi);
			if ((y.lo > tmp_neg || y.lo == 0) && y.lo < tmp_pos) {
				y.lo = tmp_pos;
			}
			if ((y.hi < tmp_pos || y.hi == 0) && y.hi > tmp_neg) {
				y.hi = tmp_neg;
			}
			if (y.lo <= y.hi)
				return true;
			...
			final double tmp_neg = RMath.div_hi(z.hi, x.hi);
			final double tmp_pos = RMath.div_lo(z.hi, x.lo);
			if ((y.lo > tmp_neg || y.lo == 0) && y.lo < tmp_pos) {
				y.lo = tmp_pos;
			}
			if ((y.hi < tmp_pos || y.hi == 0) && y.hi > tmp_neg) {
	...
	public static RealInterval uminus(final RealInterval x) {
		final RealInterval z = new RealInterval();
		z.lo = -x.hi;
		z.hi = -x.lo;
		return z;
	...
	public static RealInterval exp(final RealInterval x) {
		final RealInterval z = new RealInterval();
	...
	public static RealInterval log(final RealInterval x) throws IAException {
		final RealInterval z = new RealInterval();
		if (x.hi <= 0)
	...
	public static RealInterval tan(final RealInterval x) {
		RealInterval y = new RealInterval();
		RealInterval z = new RealInterval();
		y = div(x, new RealInterval(RMath.prevfp(2 * Math.PI), RMath.nextfp(2 * Math.PI)));
		z = tan2pi(y);
	...
	public static RealInterval asin(final RealInterval x) throws IAException {
		final RealInterval z = new RealInterval();
	...
	public static RealInterval acos(final RealInterval x) {
		final RealInterval z = new RealInterval();
	...
	public static RealInterval atan(final RealInterval x) {
		final RealInterval z = new RealInterval();
	...
	public static RealInterval sinRange(final int a, final int b) {
		switch (4 * a + b) {
		case 0:
	...
	static RealInterval sin2pi0DI(final double x) {
		return new RealInterval(RMath.sin2pi_lo(x), RMath.sin2pi_hi(x));
	}

	static RealInterval cos2pi0DI(final double x) {
	...
	/* this returns an interval containing sin(x+a/4)
	   ...
	   */
	static RealInterval eval_sin2pi(final double x, final int a) {
		switch (a) {
		case 0:
			return sin2pi0DI(x);
		case 1:
	...
	public static RealInterval sin2pi(final RealInterval x) {
		final RealInterval r = new RealInterval();
		RealInterval z = null;
		RealInterval y1 = null, y2 = null;
		int a = 0, b = 0;
		final double t1 = 0, t2 = 0;
		final double w;
	...
	public static RealInterval cos2pi(final RealInterval x) {
		final RealInterval r = new RealInterval();
		RealInterval z = null;
		RealInterval y1 = null, y2 = null;
		int a = 0, b = 0;
	...
	public static RealInterval tan2pi(final RealInterval x) {
		return div(sin2pi(x), cos2pi(x));
	}

	public static RealInterval asin2pi(final RealInterval x) throws IAException {
		final RealInterval z = new RealInterval();
		x.intersect(new RealInterval(-1.0, 1.0));
	...
	public static RealInterval acos2pi(final RealInterval x) {
		final RealInterval z = new RealInterval();
	...
	public static RealInterval atan2pi(final RealInterval x) {
		final RealInterval z = new RealInterval();
	...
	public static RealInterval midpoint(final RealInterval x) {
		final RealInterval z = new RealInterval();
		z.lo = (x.lo + x.hi) / 2.0;
		z.hi = z.lo;
	...
	public static RealInterval leftendpoint(final RealInterval x) {
		final RealInterval z = new RealInterval();
		z.lo = x.lo;
		if (Double.NEGATIVE_INFINITY < z.lo && Double.POSITIVE_INFINITY > z.lo) {
			z.hi = z.lo;
	...
	public static RealInterval rightendpoint(final RealInterval x) {
		final RealInterval z = new RealInterval();
		z.lo = x.hi;
		if (Double.NEGATIVE_INFINITY < z.lo && Double.POSITIVE_INFINITY > z.lo) {
			z.hi = z.lo;
	 ...
	 */
	public static RealInterval power(final RealInterval x, final RealInterval y) throws IAException {
		...
		final RealInterval z = exp(mul(y, log(x)));
	 ...
	 */
	public static RealInterval evenPower(final RealInterval x, final double y) throws IAException {
		double zlo, zhi;
	 ...
	 * <code>y</code> is a double.
	 */
	public static RealInterval oddPower(final RealInterval x, final double y) throws IAException {
		double zlo, zhi;
	 ...
	 */
	public static RealInterval evenRoot(final RealInterval x, final double y) throws IAException {
		double ylo, yhi, zlo, zhi;
		final double zlo1, zhi1;
	 ...
	 * <code>y</code> is a non-zero double.
	 */
	public static RealInterval oddRoot(final RealInterval x, final double y) throws IAException {
		double ylo, yhi, zlo, zhi;
	 ...
	 */
	public static RealInterval integerPower(final RealInterval x, final RealInterval y) throws IAException {
		double yy;
	 ...
	 * interval containing a single integer
	 */
	public static RealInterval integerRoot(final RealInterval x, final RealInterval y) throws IAException {
		double yy;
	 ...
	 */
	public static boolean intersectIntegerRoot(final RealInterval x, final RealInterval y, final RealInterval u)
			throws IAException {
		double yy;
		RealInterval tmp;
